	...
	async getHtml() {
        ...
        <section class="projects">
				...
				<div class="projects__items">
					...
					<div class="projects__item">
                      <h2>Recipes App</h2>
						<img src="./public/project-2.jpg" alt="My Project" />
						<div class="projects__btns">
					...
					<div class="projects__item">
                      <h2>Beast Collection</h2>
						<img src="./public/project-3.jpg" target="_blank" alt="My Project" />
						<div class="projects__btns">
					...
					<div class="projects__item">
                      <h2>Rolling Dices</h2>
						<img src="./public/project-4.jpg" alt="My Project" />
						<div class="projects__btns">
					...
					<div class="projects__item">
                      <h2>Title</h2>
						<img src="./public/project-5.jpg" alt="My Project" />
						<div class="projects__btns">
					...
					<div class="projects__item">
                      <h2>Title</h2>
						<img src="./public/project-6.jpg" alt="My Project" />
						<div class="projects__btns">
							<a href="#!" class="projects__btn">
								<i class="fas fa-eye"></i> Preview
							</a>
