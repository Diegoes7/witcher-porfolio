...
window.onscroll = function() {
    ...
    if (prevScrollpos > currentScrollPos) document.querySelector(".nav").style.top = "0";
    else document.querySelector("nav").style.top = "-50px";
    prevScrollpos = currentScrollPos;
};
document.addEventListener("DOMContentLoaded", ()=>{
    var element = document.querySelectorAll(".menu-nav__item");
    if (element) element.forEach((el, key)=>{
...
//# sourceMappingURL=index.0acf94c5.js.map
